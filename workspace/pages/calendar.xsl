...
<xsl:param name="current-root" select="concat($root-rel,'/',$current-page)"/>
...
<xsl:template match="data">	 
	...
	<xsl:choose>
		...
		<xsl:otherwise>
			<div class="calendar current-month mod">
				<ul class="calendar-menu">
					...
					<li><a href="{$current-root}/day/{$current-date-url}">Day</a></li>
					<li><a href="{$current-root}/week/{$current-date-url}">Week</a></li>
					<li class="current"><a href="{$current-root}/{$current-date-url}">Month</a></li>
					<li><a href="{$current-root}/year/{$current-date-url}">Year</a></li>
				</ul>
				<div class="box">
					<h2>
						<a>
			...
			<div class="line">
				<div class="unit size1of2">
					<div class="mod">
						<div class="calendar previous-month box">
							<h2>
								<a>
									<xsl:call-template name="get-formatted-month">
									...
									<xsl:text> </xsl:text>
									<xsl:value-of select="substring($previous-month-date,1,4)"/>
								</a>
							</h2>
							<div class="block">
								<xsl:call-template name="calendar-month">
				...
				<div class="unit size1of2">
					<div class="mod">
						<div class="calendar next-month box">
							<h2>
								<a>
									<xsl:call-template name="get-formatted-month">
									...
									<xsl:text> </xsl:text>
									<xsl:value-of select="substring($next-month-date,1,4)"/>
								</a>
							</h2>
							<div class="block">
								<xsl:call-template name="calendar-month">
