...
<xsl:param name="level">
    <xsl:choose>
		...
		<xsl:when test="$current-page = 'day'">2</xsl:when>
			...
			<div class="calendar calendar-day">
				<div class="mod">
					<ul class="calendar-menu">
						<li><a href="{$current-root}/{$previous-day-url}/">Previous Day</a></li>
						<li><a href="{$current-root}/{$next-day-url}/">Next Day</a></li>
						...
						<li class="current"><a href="{$current-root}/{$current-date-url}">Day</a></li>
