...
<xsl:template name="grid-css">
	<xsl:param name="css-path" select="concat($root-url, '/workspace/intranet/css/')"/>
...
<xsl:template name="grid-mootools">
	<xsl:param name="js-path" select="concat($root-url, '/workspace/intranet/js/')"/>
...
<xsl:template name="grid-branding-fluid960gs">
	<h1 id="branding">
		<a href="{$root-url}/fluid960gs/">The Fluid 960 Grid System</a>
	</h1>
</xsl:template>
	...
	<div class="box">
		<h2>
			<a href="#" id="toggle-ajax" class="hidden">
				<img src="{$root-url}/workspace/intranet/img/ajax-loader.gif" id="loading" alt="Loading" />
				Ajax Content
			</a>
		</h2>
			...
			<ol>
				<li class="comment" id="comment-1">
					<div class="comment-meta">
						<a href="http://www.domain7.com/" class="avatar"><img src="{$root-url}/workspace/intranet/img/photo_60x60.jpg" width="30" height="30" alt="photo"/></a>
						<ul>
	...
	<div class="box articles">
		...
		<div class="block" id="{$articles-handle}">
			<div class="first article">
				...
				<a href="{$root}/news/article/" class="image"><img src="{$root-url}/workspace/intranet/img/photo_60x60.jpg" width="60" height="60" alt="photo"/></a>
...
<xsl:template name="grid-article">
	<div class="box">
		...
		<div class="block" id="article">
			...
			<p class="meta">Vancouver, BC &#8212; Wednesday, 23 April 2008</p>
			<a href="#" class="image"><img src="{$root-url}/workspace/intranet/img/photo_60x60.jpg" width="60" height="60" alt="photo"/></a>
			<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. <a href="#">Visit site.</a></p>
			<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod. </p>
			<h5>A menu</h5>
			<ul class="menu">
...
<xsl:template name="grid-site-info-fluid960gs">
	<div class="box">
		...
		<a href="{$root-url}/workspace/licenses/GPL_license.txt">GPL</a>
		<xsl:text> / </xsl:text>
		<a href="{$root-url}/workspace/licenses/MIT_license.txt">MIT</a> 
		<xsl:text> </xsl:text>
		<a href="{$root-url}/README">Licenses</a>.</p>
	</div>
</xsl:template>
